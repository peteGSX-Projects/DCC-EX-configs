...
ONCLOSE(point_id) \
  SET(direction_pin) \
  SET(enable_pin) DELAY(PULSE) RESET(enable_pin) \
  RESET(led_pin) \
DONE \
ONTHROW(point_id) \
  RESET(direction_pin) \
...
ROKUHAN_POINT(POINT_LOOP_STATION_ENTRY,POINT_1_DIR,POINT_1_EN,POINT_LOOP_STATION_ENTRY_LED,POINT_LOOP_STATION_ENTRY_BUTTON,"Loop station entry")
ROKUHAN_POINT(POINT_LOOP_STATION_EXIT,POINT_3_DIR,POINT_3_EN,POINT_LOOP_STATION_EXIT_LED,POINT_LOOP_STATION_EXIT_BUTTON,"Loop station exit")
ROKUHAN_POINT(POINT_LOOP_SIDING,POINT_2_DIR,POINT_2_EN,POINT_LOOP_SIDING_LED,POINT_LOOP_SIDING_BUTTON,"Loop siding")
ROKUHAN_POINT(POINT_LOOP_YARD,POINT_4_DIR,POINT_4_EN,POINT_LOOP_YARD_LED,POINT_LOOP_YARD_BUTTON,"Loop to yard")
ROKUHAN_POINT(POINT_MAIN_TURNTABLE,POINT_5_DIR,POINT_5_EN,POINT_MAIN_TURNTABLE_LED,POINT_MAIN_TURNTABLE_BUTTON,"Main to turntable")
ROKUHAN_POINT(POINT_MAIN_YARD,POINT_7_DIR,POINT_7_EN,POINT_MAIN_YARD_LED,POINT_MAIN_YARD_BUTTON,"Main to yard")
ROKUHAN_POINT(POINT_YARD_SIDING_1,POINT_6_DIR,POINT_6_EN,POINT_YARD_SIDING_1_LED,POINT_YARD_SIDING_1_BUTTON,"Yard siding 1")
ROKUHAN_POINT(POINT_YARD_LOOP,POINT_8_DIR,POINT_8_EN,POINT_YARD_LOOP_LED,POINT_YARD_LOOP_BUTTON,"Yard to loop")
