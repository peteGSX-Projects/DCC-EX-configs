...
// Definition below for the Altronics motor shield with MAX471 current sensing
#define ALTRONICS_SHIELD F("ALTRONICS_SHIELD"),\
  new MotorDriver(9, 11, 8, UNUSED_PIN, A0, 2.12, 1500, UNUSED_PIN), \
  new MotorDriver(10, 13, 12, UNUSED_PIN, A1, 2.12, 1500, UNUSED_PIN)

#define MOTOR_SHIELD_TYPE ALTRONICS_SHIELD
...
#define WIFI_HOSTNAME "cocoa-rail"
//
