...
EX_TURNTABLE(TTROUTE_7, EXTT_1, 600, 114, Turn, "Storage track")
EX_TURNTABLE(TTROUTE_8, EXTT_1, 600, 2500, Turn, "Layout connection")
EX_TURNTABLE(TTROUTE_9, EXTT_1, 600, 0, Home, "Home turntable")
EX_TURNTABLE(TTROUTE_10, EXTT_1, 600, 0, Calibrate, "Calibrate turntable")
